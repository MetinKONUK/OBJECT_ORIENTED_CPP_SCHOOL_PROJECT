...
class Engine : Write{
    ...
    public:
        ...
        bool is_tank_in_tanks(int tank_id) {
        ...
        //----------------------------------
        void start_engine() {
            string message = "The engine has been started\n";
            write(message);
        };
        void stop_engine() {
            string message = "The engine has been stopped\n";
            write(message);
        };
        ...
        void connect_fuel_tank_to_engine(int tank_id) {
            ...
            string message = "Tank with id " + to_string(tank_id) + " connected to engine.\n";
            write(message);
        };
        void disconnect_fuel_tank_from_engine(int tank_id) {

            string message = "Tank with id " + to_string(tank_id) + " disconnected from engine.\n";
            write(message);
        };
        void open_valve(int tank_id) {
            string message = "Valve of tank " + to_string(tank_id) + " has been opened.\n";
            write(message);
        };
        void close_valve(int tank_id) {
            string message = "Valve of tank " + to_string(tank_id) + " has been closed.\n";
            write(message);
        };
        void break_fuel_tank(int tank_id) {
            string message = "Tank with id" + to_string(tank_id) + " has been broken.\n";
            write(message);
        };
        void repair_fuel_tank(int tank_id) {
            string message = "Tank with id" + to_string(tank_id) + " has been repaired.\n";
            write(message);
        };
        ...
        void print_fuel_tank_count() { //+
            ...
            string message = "There are " + to_string(fuel_tank_count) + " fuel tanks.\n";
            write(message);
        };
        void list_connected_tanks() {
            string message = "Listed connected tanks.\n";
            write(message);
        };
